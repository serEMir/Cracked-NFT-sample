...
mint:
	@forge script script/interactions/BasicNFTInteractions.s.sol:MintBasicNFT ${NETWORK_ARGS}

deployMood:
	@forge script script/DeployMoodNFT.s.sol:DeployMoodNFT $(NETWORK_ARGS);

mintMood:
	@forge script script/interactions/MintMoodNFT.s.sol:MintMoodNFT $(NETWORK_ARGS);

flipMood:
	@forge script script/interactions/FlipMoodNFT.s.sol:FlipMoodNFT $(NETWORK_ARGS) $(TOKEN_ID);